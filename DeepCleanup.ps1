...
[System.Windows.MessageBox]::Show("✨ Windows Deep Cleanup process completed successfully! ✨`n`nYour system will reboot in 90 seconds to finalize the cleanup. Both the registry and Windows deep cleaning were performed to ensure optimal performance. 🚀", "Cleanup Complete", [System.Windows.MessageBoxButton]::OK, [System.Windows.MessageBoxImage]::Information)

# Wait for 90 seconds before shutting down
